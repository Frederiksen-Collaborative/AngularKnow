        ...
        .config(['$routeProvider', function($routeProvider){
            $routeProvider
                ...
                .when('/lessons/lesson1', {
                    templateUrl: 'src/partials/lesson1.htm',
                    controller: 'lesson1Controller'
                })
                .when('/lessons/lesson2', {
                    templateUrl: 'src/partials/lesson2.htm',
                    controller: 'lesson2Controller'
                })
                .when('/lessons/lesson3', {
                    templateUrl: 'src/partials/lesson3.htm',
                    controller: 'lesson3Controller'
                })
                .when('/lessons/lesson4', {
                    templateUrl: 'src/partials/lesson4.htm',
                    controller: 'lesson4Controller'
                })
                .when('/misc/storage',{
                    templateUrl: 'src/partials/storage_test_partial.htm',
